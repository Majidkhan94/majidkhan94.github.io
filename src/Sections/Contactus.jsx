...
export const Contactus = () => {
  ...
  const ContactData = [
    {
      ...
      ContactParagraph: "Misryal Road Rawalpindi",
    },
    {
      ContactHeading: "Mail",
      ContactParagraph: "Majidkhan.dev94@gmail.com",
    },
    {
      ContactHeading: "Phone",
      ContactParagraph: "+923411022489",
    },
  ];
  ...
  placeholder="Message"
  required
  className="w-full bg-transparent border-b-2 border-ParaColor py-2 outline-none text-white"
/>
