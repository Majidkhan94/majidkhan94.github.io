      ...
      <section className="w-full min-h-screen flex justify-center items-center px-4 sm:px-6 md:px-10 lg:px-20 py-3 text-white">
        ...
        <div className="w-full flex flex-wrap justify-center gap-8 md:gap-12 lg:gap-15">
          ...
          {TechnicalexpertiseApi.map((item, index) => {
            return (
              <div key={index} className="relative w-full sm:w-[320px] md:w-87">
                {/* NUMBER */}
                ...
                <motion.div
                  ...
                  className="
                    flex flex-col gap-3 bg-LightColor p-5 sm:p-6 rounded-xl border border-transparent
                    hover:border-ParaColor/20 hover:-translate-y-2 hover:scale-[1.02] transition-all duration-500
                    cursor-pointer " >
